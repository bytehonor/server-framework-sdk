package com.bytehonor.standard.boot.spring.web.error.factory;

import org.slf4j.Logger;
import org.slf4j.LoggerFactory;

import com.bytehonor.standard.boot.spring.web.error.exception.InternalRestfulException;
import com.bytehonor.standard.boot.spring.web.error.exception.ServerDefinedException;
import com.bytehonor.standard.boot.spring.web.error.stragety.DefaultExceptionStragety;
import com.bytehonor.standard.boot.spring.web.error.stragety.ExceptionStragety;
import com.bytehonor.standard.boot.spring.web.error.stragety.InternalRestfulExceptionStragety;
import com.bytehonor.standard.boot.spring.web.error.stragety.NullPointerExceptionStragety;
import com.bytehonor.standard.boot.spring.web.error.stragety.ServerDefinedExceptionStragety;
